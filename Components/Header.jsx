    ...
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>
          Discover stories, insights, and practical advice on topics that matter. Our blogs are crafted to inspire curiosity, spark creativity, and help you stay informed in a fast-moving world.
        </p>
